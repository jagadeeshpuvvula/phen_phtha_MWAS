...
dat <- read_csv("~/Documents/phth_phe_MWAS/result/enrich_results_combined_march.csv") |>
  ...
  filter((chemical == "BPA" & mom_baby %in% c("Maternal", "Newborn")) |
         (chemical == "BPS" & mom_baby == "Maternal") |
...
upset(dat_olap, 
      ...
      keep.order = TRUE,
      nsets = 5,
      sets.bar.color = c("#0072B2", "#0072B2", "#0072B2", "#0072B2", "#E69F00", "#E69F00", "#E69F00", "#E69F00", "#E69F00"),
      sets = c("2,5-Dichlorophenol Newborn", "BPA Newborn", "MBP Newborn", "MBzP Newborn", "BPA Maternal", "BPS Maternal", "MiBP Maternal", "MECPTP Maternal", "MEHHTP Maternal"),
      set_size.show = TRUE,
