...
dat|>
  #ggplot(aes(x = factor(chemical, levels = c("2,5-DCP", "BP-A", "BP-S", "MBP", "MiBP", "MBzP")), y = pathway)) + 
  ggplot(aes(x = factor(chemical, levels = c("2,4-DCP", "2,5-DCP", "BP-3", "BP-A", "BP-S", 
                                              "MEP", "MBP", "MiBP","MBzP", "MONP", "MCOP", "mCNP")), y = pathway)) + 
